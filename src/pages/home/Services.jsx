...
const Services = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:items-start lg:flex-row flex-wrap mx-5">
        {staticData.map((val, ind) => {
          return (
            <div className="lg:w-4/12 mt-24" key={ind}>
              <div className="flex items-center">
                <img src={val.img} />
                <p
                  className="ml-5 font-poppins text-lg text-white font-semibold pb-1"
                  style={{ borderBottom: "5px solid #E547FF" }}
                >
                  {val.name}
                </p>
              </div>
