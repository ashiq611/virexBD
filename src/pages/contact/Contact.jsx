...
const Contact = () => {
  ...
  return (
    <div className=" px-5 py-28 lg:px-20 lg:py-32 ">
      <div className="flex flex-col lg:flex-row justify-between">
        <div className="lg:w-4/12">
          <div style={{ height: "50vh", width: "100%", borderRadius: "30%" }}>
            <GoogleMapReact
              bootstrapURLKeys={{
                key: "AIzaSyA6IELrAzDC0cdO5Ye0xVFuudXEZZuOmzc",
              }}
              defaultCenter={defaultProps.center}
              defaultZoom={defaultProps.zoom}
            >
              <AnyReactComponent lat={23.8746} lng={90.3888} text="" />
            </GoogleMapReact>
          </div>
          <div className="bg-white  px-8 py-8 mt-5 rounded-lg">
            ...
            <div className="flex list-none mt-5">
              <li className="mr-3">
                <Link className=" bg-purple2 block flex items-center justify-center px-3  py-2 rounded-sm">
                  <img className="w-4" src={first} />
                </Link>
              </li>
              <li className="mr-3">
                <Link className=" bg-purple2 block flex items-center justify-center px-3  py-2 rounded-sm">
                  <img className="w-4" src={second} />
                </Link>
              </li>
              <li className="mr-3">
                <Link className=" bg-purple2 block flex items-center justify-center px-3  py-2 rounded-sm">
                  <img className="w-4" src={third} />
                </Link>
              </li>
              <li className="mr-3">
                <Link className=" bg-purple2 block flex items-center justify-center px-3  py-2 rounded-sm">
                  <img className="w-4" src={four} />
                </Link>
              </li>
              <li className="mr-3">
                <Link className=" bg-purple2 block flex items-center justify-center px-3  py-2 rounded-sm">
                  <img className="w-4" src={five} />
                </Link>
              </li>
            </div>
          </div>
        </div>
        <div className="lg:w-7/12  mt-5">
          ...
          <form className="mt-5" onSubmit={handleSubmit}>
            <div className="flex justify-between">
              <input
                ...
                placeholder="Name"
                className="py-1 px-2 font-poppins rounded-md w-6/12 mr-2 text-white"
                type="text"
                required
              />
              <input
                style={{ background: "none", border: "1px solid white" }}
                placeholder="Email"
                className="py-1 px-2 font-poppins rounded-md w-6/12 text-white"
                type="email"
                required
              />
            </div>
            ...
            <textarea
              style={{ background: "none", border: "1px solid white" }}
              className="w-full mt-5 px-1 rounded-md text-white"
              rows={10}
              placeholder="Message "
            ></textarea>
            <button className=" bg-purple2 font-poppins font-medium text-xs px-5 py-3 rounded-md mt-5 text-white">
              Send Message
            </button>
          </form>
        </div>
